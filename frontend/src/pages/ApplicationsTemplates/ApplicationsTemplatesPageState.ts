...
export class ApplicationsTemplatesPageState extends CrudState
{
	 ...
	 */
	getApiUrlUpdate(item: ApplicationTemplate)
	{
	 ...
	 */
	getApiUrlDelete(item: ApplicationTemplate)
	{
	 ...
	 * Return api update url
	 */
	getApiUrlCompose(item: ApplicationTemplate)
	{
	...
	{
		let model:ApplicationsTemplatesPageState = component.model;
		let response:AxiosResponse | null = null;
		let item:ApplicationTemplate = model.active_item as ApplicationTemplate;
		...
		if (item != null)
		{
			...
			{
				item = model.createNewItemInstance(response.data.result.item) as ApplicationTemplate;
