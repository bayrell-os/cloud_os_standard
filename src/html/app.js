	...
	render: function(ctx, layout, model, params, content)
	{
		return (__control) =>
		{
			...
			var __v0 = __control.e("element", "div")
				.a({"class":["layout", this.getCssHash(ctx)].join(" "),"@elem_name":"layout"})
				.r();
			
			/* Element 'div.layout_wrap' */
			var __v1 = __v0.e("element", "div")
				.a({"class":["layout_wrap", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_wrap"})
				.r();
			
			/* Element 'div.layout_menu_wrap' */
			var __v2 = __v1.e("element", "div")
				.a({"class":["layout_menu_wrap", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_menu_wrap"})
				.r();
			
			/* Element 'div.layout_site_name' */
			var __v3 = __v2.e("element", "div")
				.a({"class":["layout_site_name", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_site_name"})
				.r();
			
			/* Element 'a.nolink' */
			var __v4 = __v3.e("element", "a")
				.a({"href":"/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v4.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS.Simple", "Cloud OS"))
				.r();
			;
			__v4.p();
			__v3.p();
			...
			var __v3 = __v2.e("element", "div")
				.a({"class":["layout_menu", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_menu"})
				.r();
			
			/* Element 'div.layout_menu_label' */
			var __v4 = __v3.e("element", "div")
				.a({"class":["layout_menu_label", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_menu_label"})
				.r();
			
			/* Text */
			__v4.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Dashboard"))
				.r();
			;
			__v4.p();
			...
			var __v4 = __v3.e("element", "div")
				.a({"class":["layout_menu_items", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_menu_items"})
				.r();
			
			/* Element 'ul' */
			var __v5 = __v4.e("element", "ul")
				.r();
			
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.dashboard.main")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Main"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.services")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/services/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Services"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.yaml_files")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/yaml_files/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Yaml files"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.domains")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/domains/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Domains"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.routes")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/routes/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Routes"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.nginx")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/nginx/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Nginx Files"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'li' */
			var __v6 = __v5.e("element", "li")
				.a({"class":[((Runtime.rs.start(ctx, Runtime.rtl.attr(ctx, layout, ["route", "name"]), "app.admin.users")) ? ("active") : ("")), this.getCssHash(ctx)].join(" ")})
				.r();
			
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/users/","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Users"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			/* Element 'a.nolink' */
			var __v7 = __v6.e("element", "a")
				.a({"href":"/admin/database/","target":"_blank","class":["nolink", this.getCssHash(ctx)].join(" "),"@elem_name":"nolink"})
				.r();
			
			/* Text */
			__v7.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Adminer"))
				.r();
			;
			__v7.p();
			__v6.p();
			...
			var __v2 = __v1.e("element", "div")
				.a({"class":["layout_content_wrap", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_content_wrap"})
				.r();
			
			/* Element 'div.layout_title' */
			var __v3 = __v2.e("element", "div")
				.a({"class":["layout_title", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_title"})
				.r();
			...
			var __v3 = __v2.e("element", "div")
				.a({"class":["layout_content", this.getCssHash(ctx)].join(" "),"@elem_name":"layout_content"})
				.r();
			
			if (!Runtime.rtl.isEmpty(ctx, class_name))
			{
				/* Component '{class_name}' */
				__v3.e("component", class_name)
					.a({"@bind":["Bayrell.CloudOS.DefaultLayout","page_model"],"@key":"view"})
					.r();
			}
			__v3.p();
			__v2.p();
 ...
 */
	getFilterFields: function(ctx, container)
	{
		return Runtime.Collection.from(["enable","protocol","domain_name","docker_name"]);
	},
	/**
 * Returns form fields
 */
	getFormFields: function(ctx, container)
	{
		return Runtime.Collection.from(["enable","protocol","domain_name","route","docker_name","target_port","route_prefix"]);
	},
	/**
 * Returns table fields
 */
	getTableFields: function(ctx, container)
	{
		return Runtime.Collection.from(["number","enable","protocol","domain_name","route","docker_name","target_port","route_prefix","edit-buttons"]);
	},
	/**
 * Returns view fields
 */
 ...
 * Stop
 */
	onStopClick: async function(ctx, msg)
	{
		var pk = Runtime.rtl.get(ctx, msg.sender.params, "data-pk");
		var item = this.call(ctx, "getFirstItem", pk);
		this.dialog_stop.update(ctx, "confirm", "Do you realy want to stop '" + Runtime.rtl.toStr(Runtime.rtl.get(ctx, item, "docker_name")) + Runtime.rtl.toStr("' ?"));
		this.dialog_stop.update(ctx, "copy", Runtime.Dict.from({"tag":Runtime.Dict.from({"pk":pk,"item":item})}));
	},
	/**
 * Stop dialog event
 */
	onStopDialogEvent: async function(ctx, msg)
	{
		if (msg.data.button_result == "ok")
		{
			var pk = this.dialog_stop.model(ctx, Runtime.Collection.from(["tag","pk"]));
			this.dialog_stop.update(ctx, "copy", Runtime.Dict.from({"message":"Wait for stop service"}));
			this.dialog_stop.update(ctx, "copy", Runtime.Dict.from({"error_message":""}));
			/* Call api */
			var answer = await Runtime.Web.RenderDriver.externalBusCall(ctx, Runtime.Dict.from({"object_name":this.constructor.getCrudObjectName(ctx),"interface_name":"core.crud","method_name":"stop","data":Runtime.Dict.from({"pk":pk})}));
			if (answer.isSuccess(ctx))
			{
				if (answer.response.has(ctx, "new_item"))
				{
					this.update(ctx, "setItem", pk, Runtime.rtl.get(ctx, answer.response, "new_item"));
				}
				this.dialog_stop.update(ctx, "hide");
			}
			else
			{
				this.dialog_stop.update(ctx, "copy", Runtime.Dict.from({"message":""}));
				this.dialog_stop.update(ctx, "copy", Runtime.Dict.from({"error_message":answer.error_message}));
			}
		}
 ...
 */
	actionIndex: async function(ctx, container)
	{
		...
		__v0 = __v0.call(ctx, Runtime.lib.setAttr(ctx, Runtime.Collection.from(["layout","page_model"]), new Bayrell.CloudOS.Design.ServicePageModel(ctx)));
		__v0 = await __v0.callAsync(ctx, this.crudSearch.bind(this));
		return Runtime.Collection.from([__v0.value(ctx)]);
	},
	/**
 ...
 */
	getFormFields: function(ctx, container)
	{
		return Runtime.Collection.from(["stack_name","service_name","have_admin_page","admin_port","admin_route","admin_custom_nginx"]);
	},
	/**
 * Returns table fields
 */
	getTableFields: function(ctx, container)
	{
		return Runtime.Collection.from(["number","docker_name","docker_image","docker_replicas","enable","have_admin_page","edit-buttons"]);
	},
	/**
 * Returns view fields
 */
 ...
 */
	...
	{
		var item = Runtime.rtl.get(ctx, crud_settings, "crud_item");
		var struct = Runtime.rtl.get(ctx, crud_settings, "crud_struct");
		var index = Runtime.rtl.get(ctx, crud_settings, "crud_index");
		/* Table number */
		if (kind == "table" && field_name == "number")
		{
			return this.renderNumber(ctx, layout, value, crud_settings);
		...
		if (kind == "table" && field_name == "have_admin_page")
		{
			...
			}) : ((__control) =>
			{
				...
				/* Element 'div' */
				var __v1 = __v0.e("element", "div")
					.a({"style":"display:inline-block;vertical-align: middle; margin-right: 5px;"})
					.r();
				
				/* Text */
				__v1.e("text")
					.c(this.renderButton(ctx, layout, crud_settings, "view", Runtime.Dict.from({"url":"/admin/services/" + Runtime.rtl.toStr(Runtime.rtl.get(ctx, Runtime.rtl.get(ctx, crud_settings, "crud_item"), "docker_name")) + Runtime.rtl.toStr("/"),"target":"_blank"})))
					.r();
				;
				__v1.p();
				...
				/* Element 'div' */
				var __v1 = __v0.e("element", "div")
					.a({"style":"display:inline-block;vertical-align: middle; margin-left: 5px;"})
					.r();
				...
				/* Text */
				__v2.e("text")
					.c(Runtime.rtl.get(ctx, item, "admin_port"))
					.r();
				;
				__v2.p();
				...
				/* Text */
				__v2.e("text")
					.c(Runtime.rtl.get(ctx, item, "admin_route"))
					.r();
				;
				__v2.p();
				__v1.p();
		...
		if (kind == "table" && field_name == "edit-buttons")
		{
			return Runtime.Collection.from([this.renderButton(ctx, layout, crud_settings, "edit"),(Runtime.rtl.get(ctx, item, "enable") == true) ? (this.renderButton(ctx, layout, crud_settings, "stop")) : (this.renderButton(ctx, layout, crud_settings, "delete"))]);
		}
		/* Admin page settings */
 ...
 */
	...
	renderButton: function(ctx, layout, settings, button_type, options)
	{
		...
		return (__control) =>
		{
			...
			{
				/* Component 'Button' */
				__control.e("component", "Runtime.Web.Input.Button")
					.a({"type":"small danger","data-index":index,"data-pk":this.getPrimaryKey(ctx, struct, item),"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.ServicePage","onStopClick"],"@key":"compose"})
					.c((__control) =>
					{
						
						/* Text */
						__control.e("text")
							.c(ctx.translate(ctx, "Runtime.Web.CRUD", "Stop"))
							.r();
						;
			...
			else
			{
				/* Text */
				__control.e("text")
					.c(Runtime.Web.CRUD.CrudPage.renderButton.call(this, ctx, layout, settings, button_type, options))
					.r();
				;
			}
	...
	renderDialog: function(ctx, layout, model, params)
	{
		return (__control) =>
		{
			...
			/* Text */
			__control.e("text")
				.c(Runtime.Web.CRUD.CrudPage.renderDialog.call(this, ctx, layout, model, params))
				.r();
			;
			
			/* Element 'div.dialogs' */
			var __v0 = __control.e("element", "div")
				.a({"class":["dialogs", this.getCssHash(ctx)].join(" "),"@elem_name":"dialogs"})
				.r();
			
			/* Component 'Dialog' */
			__v0.e("component", "Runtime.Web.Dialog.Dialog")
				.a({"@name":["Bayrell.CloudOS.Design.ServicePage","dialog_stop"],"auto_hide":false,"@event:Runtime.Web.Dialog.DialogEvent":["Bayrell.CloudOS.Design.ServicePage","onStopDialogEvent"]})
				.r();
			__v0.p();
	...
	components: function(ctx)
	{
		return Runtime.Collection.from(["Runtime.Web.CRUD.CrudPage","Runtime.Web.CRUD.CrudPage","Runtime.Web.Dialog.Dialog","Runtime.Web.Input.Button","Runtime.Web.Input.Input","Runtime.Web.Input.Label","Runtime.Web.Input.Select","Runtime.Web.Input.SelectText","Runtime.Web.Input.TextArea"]);
	},
	/* ======================= Class Init Functions ======================= */
	getCurrentNamespace: function()
	{
...
if (typeof Bayrell.CloudOS == 'undefined') Bayrell.CloudOS = {};
if (typeof Bayrell.CloudOS.Design == 'undefined') Bayrell.CloudOS.Design = {};
Bayrell.CloudOS.Design.ServicePageModel = function(ctx)
{
	Runtime.Web.CRUD.CrudPageModel.apply(this, arguments);
};
Bayrell.CloudOS.Design.ServicePageModel.prototype = Object.create(Runtime.Web.CRUD.CrudPageModel.prototype);
Bayrell.CloudOS.Design.ServicePageModel.prototype.constructor = Bayrell.CloudOS.Design.ServicePageModel;
Object.assign(Bayrell.CloudOS.Design.ServicePageModel.prototype,
{
	_init: function(ctx)
	{
		var defProp = use('Runtime.rtl').defProp;
		var a = Object.getOwnPropertyNames(this);
		this.dialog_stop = new Runtime.Web.Dialog.DialogModel(ctx, Runtime.Dict.from({}));
		Runtime.Web.CRUD.CrudPageModel.prototype._init.call(this,ctx);
	},
	assignObject: function(ctx,o)
	{
		if (o instanceof Bayrell.CloudOS.Design.ServicePageModel)
		{
			this.dialog_stop = o.dialog_stop;
		}
		Runtime.Web.CRUD.CrudPageModel.prototype.assignObject.call(this,ctx,o);
	},
	assignValue: function(ctx,k,v)
	{
		if (k == "dialog_stop")this.dialog_stop = v;
		else Runtime.Web.CRUD.CrudPageModel.prototype.assignValue.call(this,ctx,k,v);
	},
	takeValue: function(ctx,k,d)
	{
		if (d == undefined) d = null;
		if (k == "dialog_stop")return this.dialog_stop;
		return Runtime.Web.CRUD.CrudPageModel.prototype.takeValue.call(this,ctx,k,d);
	},
	getClassName: function(ctx)
	{
		return "Bayrell.CloudOS.Design.ServicePageModel";
	},
});
Object.assign(Bayrell.CloudOS.Design.ServicePageModel, Runtime.Web.CRUD.CrudPageModel);
Object.assign(Bayrell.CloudOS.Design.ServicePageModel,
{
	/* ======================= Class Init Functions ======================= */
	getCurrentNamespace: function()
	{
	...
	getClassInfo: function(ctx)
	{
		...
		return Dict.from({
			"kind": "class",
			"class_name": "Bayrell.CloudOS.Design.ServicePageModel",
			"name": "Bayrell.CloudOS.Design.ServicePageModel",
			"annotations": Collection.from([
			]),
		});
	},
	...
	getFieldInfoByName: function(ctx,field_name)
	{
		var Collection = Runtime.Collection;
		var Dict = Runtime.Dict;
		if (field_name == "dialog_stop") return Dict.from({
			"kind": "field",
			"class_name": "Bayrell.CloudOS.Design.ServicePageModel",
...
Runtime.rtl.defClass(Bayrell.CloudOS.Design.ServicePageModel);
window["Bayrell.CloudOS.Design.ServicePageModel"] = Bayrell.CloudOS.Design.ServicePageModel;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Bayrell.CloudOS.Design.ServicePageModel;
"use strict;"
/*
 *  Bayrell Cloud OS
 *
...
Object.assign(Bayrell.CloudOS.Design.YamlFilesPage.prototype,
{
	...
	onEditFile: async function(ctx, msg)
	{
		...
		this.update(ctx, "copy", Runtime.Dict.from({"current_dialog_file":current_dialog_file,"edit_file_name":file_name,"edit_stack":false}));
	...
	onDeleteFile: async function(ctx, msg)
	{
		...
		var file_name = Runtime.rtl.get(ctx, msg.sender.params, "file-name");
		var current_dialog_file = stack_name + Runtime.rtl.toStr("/") + Runtime.rtl.toStr(file_name);
		this.update(ctx, "copy", Runtime.Dict.from({"current_dialog_file":current_dialog_file,"edit_stack":false}));
		this.delete_dialog.update(ctx, "confirm", "Do you realy want to delete file '" + Runtime.rtl.toStr(current_dialog_file) + Runtime.rtl.toStr("' ?"));
	},
	/* Edit stack */
	onEditStack: async function(ctx, msg)
	{
		msg.cancel(ctx);
		var stack_name = Runtime.rtl.get(ctx, msg.sender.params, "stack-name");
		this.update(ctx, "copy", Runtime.Dict.from({"current_dialog_file":stack_name,"edit_file_name":stack_name,"edit_stack":true}));
		this.edit_dialog.update(ctx, "show");
	},
	/* Delete stack */
	onDeleteStack: async function(ctx, msg)
	{
		msg.cancel(ctx);
		var stack_name = Runtime.rtl.get(ctx, msg.sender.params, "stack-name");
		this.update(ctx, "copy", Runtime.Dict.from({"current_dialog_file":stack_name,"edit_stack":true}));
		this.delete_dialog.update(ctx, "confirm", "Do you realy want to delete stack '" + Runtime.rtl.toStr(stack_name) + Runtime.rtl.toStr("' ?"));
	},
	/* Dialog event */
	onDialogEvent: async function(ctx, msg)
	{
		...
		else if (msg.sender == this.edit_dialog)
		{
			if (msg.data.button_result == "ok")
			{
				...
				var edit_stack = Runtime.rtl.get(ctx, model, "edit_stack");
				/* Edit stack */
				if (edit_stack)
				{
					...
					/* Call api */
					var answer = await Runtime.Web.RenderDriver.externalBusCall(ctx, Runtime.Dict.from({"object_name":"Bayrell.CloudOS.YamlFiles","interface_name":"default","method_name":"editStack","data":Runtime.Dict.from({"stack_name":current_dialog_file,"stack_name_new":edit_file_name})}));
					if (answer.isSuccess(ctx))
					{
						await this.reloadFileList(ctx);
		...
		else if (msg.sender == this.delete_dialog)
		{
			if (msg.data.button_result == "ok")
			{
				...
				if (edit_stack)
				{
					...
					/* Call api */
					var answer = await Runtime.Web.RenderDriver.externalBusCall(ctx, Runtime.Dict.from({"object_name":"Bayrell.CloudOS.YamlFiles","interface_name":"default","method_name":"deleteStack","data":Runtime.Dict.from({"stack_name":current_dialog_file})}));
					if (answer.isSuccess(ctx))
					{
						await this.reloadFileList(ctx);
 ...
 */
	...
	css: function(ctx, vars)
	{
		return ".left-panel.h-0b09, .right-content.h-0b09{" + Runtime.rtl.toStr("display: inline-block;vertical-align: top;") + Runtime.rtl.toStr("}.left-panel.h-0b09{") + Runtime.rtl.toStr("width: 200px;padding-right: 10px;") + Runtime.rtl.toStr("}.right-content.h-0b09{") + Runtime.rtl.toStr("width: calc(100% - 200px);") + Runtime.rtl.toStr("}.items.h-0b09{") + Runtime.rtl.toStr("padding-top: 10px;") + Runtime.rtl.toStr("}.item.h-0b09{") + Runtime.rtl.toStr("padding-bottom: 10px;") + Runtime.rtl.toStr("}.item.h-0b09:last-child{") + Runtime.rtl.toStr("padding-bottom: 0px;") + Runtime.rtl.toStr("}.label.h-0b09{") + Runtime.rtl.toStr("padding-right: 5px;font-weight: bold;padding-bottom: 10px;user-select: none;") + Runtime.rtl.toStr("}.stack-name.h-0b09, .stack-icons.h-0b09{") + Runtime.rtl.toStr("display: inline-block;vertical-align: top;") + Runtime.rtl.toStr("}.stack-name.h-0b09{") + Runtime.rtl.toStr("width: calc(100% - 40px);") + Runtime.rtl.toStr("}.stack-icons.h-0b09{") + Runtime.rtl.toStr("display: none;width: 40px;cursor: pointer;") + Runtime.rtl.toStr("}.stack-icons.h-0b09 .far.h-0b09{") + Runtime.rtl.toStr("display: inline-block;margin-left: 5px;") + Runtime.rtl.toStr("}.label.h-0b09:hover .stack-icons.h-0b09{") + Runtime.rtl.toStr("display: inline-block;") + Runtime.rtl.toStr("}.files.h-0b09{") + Runtime.rtl.toStr("padding-left: 10px;") + Runtime.rtl.toStr("}.file.h-0b09{") + Runtime.rtl.toStr("padding: 5px;cursor: pointer;user-select: none;") + Runtime.rtl.toStr("}.file.h-0b09:hover{") + Runtime.rtl.toStr("background-color: #eee;") + Runtime.rtl.toStr("}.file.h-0b09.active{") + Runtime.rtl.toStr("background-color: " + Runtime.rtl.toStr(Runtime.rtl.attr(ctx, vars, ["colors", "primary", "color"])) + Runtime.rtl.toStr(";color: ") + Runtime.rtl.toStr(Runtime.rtl.attr(ctx, vars, ["colors", "primary", "text"])) + Runtime.rtl.toStr(";")) + Runtime.rtl.toStr("}.file-name.h-0b09, .file-icons.h-0b09{") + Runtime.rtl.toStr("display: inline-block;vertical-align: top;") + Runtime.rtl.toStr("}.file-name.h-0b09{") + Runtime.rtl.toStr("width: calc(100% - 40px);") + Runtime.rtl.toStr("}.file-icons.h-0b09{") + Runtime.rtl.toStr("display: none;width: 40px;") + Runtime.rtl.toStr("}.file.h-0b09:hover .file-icons.h-0b09{") + Runtime.rtl.toStr("display: inline-block;") + Runtime.rtl.toStr("}.file-icons.h-0b09 .far.h-0b09{") + Runtime.rtl.toStr("display: inline-block;margin-left: 5px;") + Runtime.rtl.toStr("}.right-content.h-0b09 .input.h-106c{") + Runtime.rtl.toStr("width: calc(100% - 20px);height: calc(100% - 20px);outline: 0;") + Runtime.rtl.toStr("}.content_file_name.h-0b09{") + Runtime.rtl.toStr("padding-bottom: 5px;min-height: 35px;") + Runtime.rtl.toStr("}.content_file_name.h-0b09 .button.h-de49{") + Runtime.rtl.toStr("margin-left: 10px;") + Runtime.rtl.toStr("}.form-label.h-0b09{") + Runtime.rtl.toStr("font-weight: bold;text-align: center;padding-bottom: 10px;") + Runtime.rtl.toStr("}.form-row.h-0b09{") + Runtime.rtl.toStr("padding-bottom: 10px;") + Runtime.rtl.toStr("}.form-row.h-0b09:last-child{") + Runtime.rtl.toStr("padding-bottom: 0px;") + Runtime.rtl.toStr("}.form-row.h-0b09 label{") + Runtime.rtl.toStr("display: block;padding-bottom: 5px;font-weight: bold;") + Runtime.rtl.toStr("}");
	},
	render: function(ctx, layout, model, params, content)
	{
		return (__control) =>
		{
			...
			var __v0 = __control.e("element", "div")
				.a({"class":["left-panel", this.getCssHash(ctx)].join(" "),"@elem_name":"left-panel"})
				.r();
			
			/* Component 'Button' */
			__v0.e("component", "Runtime.Web.Input.Button")
				.a({"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onAddFile"]})
				.c((__control) =>
				{
			...
			/* Element 'div.items' */
			var __v1 = __v0.e("element", "div")
				.a({"class":["items", this.getCssHash(ctx)].join(" "),"@elem_name":"items"})
				.r();
			...
			for (var i = 0;i < stacks.count(ctx);i++)
			{
				...
				/* Element 'div.item' */
				var __v2 = __v1.e("element", "div")
					.a({"class":["item", this.getCssHash(ctx)].join(" "),"@elem_name":"item"})
					.r();
				
				/* Element 'div.label' */
				var __v3 = __v2.e("element", "div")
					.a({"class":["label", this.getCssHash(ctx)].join(" "),"@elem_name":"label"})
					.r();
				
				var attrs = Runtime.Dict.from({"stack-name":Runtime.rtl.get(ctx, stack, "name")});
				
				/* Element 'span.stack-name' */
				var __v4 = __v3.e("element", "span")
					.a({"class":["stack-name", this.getCssHash(ctx)].join(" "),"@elem_name":"stack-name"})
					.r();
				
				/* Text */
				__v4.e("text")
					.c(Runtime.rtl.get(ctx, stack, "name"))
					.r();
				;
				__v4.p();
				
				/* Element 'span.stack-icons' */
				var __v4 = __v3.e("element", "span")
					.a({"class":["stack-icons", this.getCssHash(ctx)].join(" "),"@elem_name":"stack-icons"})
					.r();
				
				/* Element 'i.far.fa-edit' */
				__v4.e("element", "i")
					.a(this.mergeAttrs(ctx, {"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onEditStack"],"class":["far fa-edit", this.getCssHash(ctx)].join(" "),"@elem_name":"far"},attrs))
					.r();
				
				/* Element 'i.far.fa-trash-alt' */
				__v4.e("element", "i")
					.a(this.mergeAttrs(ctx, {"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onDeleteStack"],"class":["far fa-trash-alt", this.getCssHash(ctx)].join(" "),"@elem_name":"far"},attrs))
					.r();
				__v4.p();
				__v3.p();
				...
				/* Element 'div.files' */
				var __v3 = __v2.e("element", "div")
					.a({"class":["files", this.getCssHash(ctx)].join(" "),"@elem_name":"files"})
					.r();
				...
				for (var j = 0;j < files.count(ctx);j++)
				{
					...
					/* Element 'div.file' */
					var __v4 = __v3.e("element", "div")
						.a(this.mergeAttrs(ctx, {"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onOpenFile"],"class":["file", checked, this.getCssHash(ctx)].join(" "),"@elem_name":"file"},attrs))
						.r();
					
					/* Element 'span.file-name' */
					var __v5 = __v4.e("element", "span")
						.a({"class":["file-name", this.getCssHash(ctx)].join(" "),"@elem_name":"file-name"})
						.r();
					
					/* Text */
					__v5.e("text")
						.c(Runtime.rtl.get(ctx, files, j))
						.r();
					;
					__v5.p();
					...
					var __v5 = __v4.e("element", "span")
						.a({"class":["file-icons", this.getCssHash(ctx)].join(" "),"@elem_name":"file-icons"})
						.r();
					
					/* Element 'i.far.fa-edit' */
					__v5.e("element", "i")
						.a(this.mergeAttrs(ctx, {"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onEditFile"],"class":["far fa-edit", this.getCssHash(ctx)].join(" "),"@elem_name":"far"},attrs))
						.r();
					
					/* Element 'i.far.fa-trash-alt' */
					__v5.e("element", "i")
						.a(this.mergeAttrs(ctx, {"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onDeleteFile"],"class":["far fa-trash-alt", this.getCssHash(ctx)].join(" "),"@elem_name":"far"},attrs))
						.r();
					__v5.p();
					__v4.p();
				}
			...
			var __v0 = __control.e("element", "div")
				.a({"class":["right-content", this.getCssHash(ctx)].join(" "),"@elem_name":"right-content"})
				.r();
			
			/* Element 'div.content_file_name' */
			var __v1 = __v0.e("element", "div")
				.a({"class":["content_file_name", this.getCssHash(ctx)].join(" "),"@elem_name":"content_file_name"})
				.r();
			
			/* Text */
			__v1.e("text")
				.c(Runtime.rtl.get(ctx, model, "current_file"))
				.r();
			;
			...
			{
				/* Component 'Button' */
				__v1.e("component", "Runtime.Web.Input.Button")
					.a({"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onSaveFile"]})
					.c((__control) =>
					{
				...
				if (this.canCompose(ctx, Runtime.rtl.get(ctx, model, "current_file")))
				{
					/* Component 'Button' */
					__v1.e("component", "Runtime.Web.Input.Button")
						.a({"@event:Runtime.Web.Events.MouseClickEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onCompose"]})
						.c((__control) =>
						{
			...
			/* Component 'TextArea' */
			__v0.e("component", "Runtime.Web.Input.TextArea")
				.a({"@name":["Bayrell.CloudOS.Design.YamlFilesPage","content"]})
				.r();
			__v0.p();
			
			/* Component 'Dialog' */
			__control.e("component", "Runtime.Web.Dialog.Dialog")
				.a({"@name":["Bayrell.CloudOS.Design.YamlFilesPage","dialog"]})
				.r();
			
			/* Component 'Dialog' */
			__control.e("component", "Runtime.Web.Dialog.Dialog")
				.a({"@name":["Bayrell.CloudOS.Design.YamlFilesPage","create_dialog"],"auto_hide":false,"style":Runtime.Web.Dialog.DialogModel.STYLE_CONTENT,"@event:Runtime.Web.Dialog.DialogEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onDialogEvent"]})
				.c((__control) =>
				{
					
					/* Element 'div.form-row' */
					var __v0 = __control.e("element", "div")
						.a({"class":["form-row", this.getCssHash(ctx)].join(" "),"@elem_name":"form-row"})
						.r();
					
					/* Element 'label' */
					var __v1 = __v0.e("element", "label")
						.r();
					...
					/* Component 'Input' */
					__v0.e("component", "Runtime.Web.Input.Input")
						.a({"@bind":["Bayrell.CloudOS.Design.YamlFilesPage","create_stack_name"]})
						.r();
					__v0.p();
					...
					/* Component 'Input' */
					__v0.e("component", "Runtime.Web.Input.Input")
						.a({"@bind":["Bayrell.CloudOS.Design.YamlFilesPage","create_file_name"]})
						.r();
					__v0.p();
			...
			/* Component 'Dialog' */
			__control.e("component", "Runtime.Web.Dialog.Dialog")
				.a({"@name":["Bayrell.CloudOS.Design.YamlFilesPage","edit_dialog"],"auto_hide":false,"style":Runtime.Web.Dialog.DialogModel.STYLE_CONTENT,"@event:Runtime.Web.Dialog.DialogEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onDialogEvent"]})
				.c((__control) =>
				{
					...
					if (Runtime.rtl.get(ctx, model, "edit_stack"))
					{
						/* Element 'div.form-label' */
						var __v1 = __v0.e("element", "div")
							.a({"class":["form-label", this.getCssHash(ctx)].join(" "),"@elem_name":"form-label"})
							.r();
					...
					/* Component 'Input' */
					__v0.e("component", "Runtime.Web.Input.Input")
						.a({"@bind":["Bayrell.CloudOS.Design.YamlFilesPage","edit_file_name"]})
						.r();
					__v0.p();
			...
			/* Component 'Dialog' */
			__control.e("component", "Runtime.Web.Dialog.Dialog")
				.a({"@name":["Bayrell.CloudOS.Design.YamlFilesPage","delete_dialog"],"auto_hide":false,"@event:Runtime.Web.Dialog.DialogEvent":["Bayrell.CloudOS.Design.YamlFilesPage","onDialogEvent"]})
				.r();
...
Object.assign(Bayrell.CloudOS.Other.AdminerPage,
{
	render: function(ctx, layout, model, params, content)
	{
		return (__control) =>
		{
			...
			/* Text */
			__v0.e("text")
				.c("Redirect. Please wait...")
				.r();
			
			/* Element 'form' */
			var __v1 = __v0.e("element", "form")
				.a({"id":"adminer_form","method":"post","action":layout.route_prefix + Runtime.rtl.toStr("/admin/database/4.7.6/")})
				.r();
			
			/* Element 'input' */
			__v1.e("element", "input")
				.a({"type":"hidden","name":"auth[driver]","value":"server"})
				.r();
			
			/* Element 'input' */
			__v1.e("element", "input")
				.a({"type":"hidden","name":"auth[server]","value":Runtime.rtl.attr(ctx, model, ["db", "host"])})
				.r();
			
			/* Element 'input' */
			__v1.e("element", "input")
				.a({"type":"hidden","name":"auth[username]","value":Runtime.rtl.attr(ctx, model, ["db", "username"])})
				.r();
			
			/* Element 'input' */
			__v1.e("element", "input")
				.a({"type":"hidden","name":"auth[password]","value":Runtime.rtl.attr(ctx, model, ["db", "password"])})
				.r();
			
			/* Element 'input' */
			__v1.e("element", "input")
				.a({"type":"hidden","name":"auth[permanent]","value":"1"})
				.r();
			__v1.p();
			__v0.p();
...
Object.assign(Bayrell.CloudOS.Page404,
{
	...
	render: function(ctx, layout, model, params, content)
	{
		return (__control) =>
		{
			...
			/* Text */
			__control.e("text")
				.c(ctx.translate(ctx, "Bayrell.CloudOS", "Page not found"))
				.r();
			;
...
Object.assign(Bayrell.CloudOS.ModuleDescription,
{
	...
	{
		return Runtime.Dict.from({"Runtime":">=0.3","Runtime.Web.App":"*","Runtime.Web.Auth":"*","Runtime.Web.CRUD":"*"});
	},
	/**
	 * Returns enities
	 */
	...
	{
		return Runtime.Dict.from({"config":Runtime.Dict.from({"Runtime.Web":Runtime.Dict.from({"f_inc":(ctx.env(ctx, "APP_MODE", "prod") == "prod") ? (2) : (Runtime.rtl.utime(ctx))})})});
	},
	/**
	 * Init app
	 */
