...
class DefaultRoute extends Route
{
	...
	function routes(RouteList $routes)
	{
		$arr = [
			...
			"site:applications:edit" => "/applications/edit/{id}/",
			"site:templates" => "/templates/",
			"site:templates:edit" => "/templates/edit/{id}/",
			"site:templates:view" => "/templates/view/{id}/",
			"site:templates:import" => "/templates/import/",
			"site:modificators" => "/modificators/",
			"site:modificators:add" => "/modificators/add/",
			"site:modificators:edit" => "/modificators/edit/{id}/",
			"site:services" => "/services/",
			"site:yaml_files" => "/yaml_files/",
			"site:yaml_files:edit" => "/yaml_files/edit/{id}/",
			"site:stacks" => "/stacks/",
			"site:spaces" => "/spaces/",
			"site:spaces:edit" => "/spaces/edit/{id}/",
